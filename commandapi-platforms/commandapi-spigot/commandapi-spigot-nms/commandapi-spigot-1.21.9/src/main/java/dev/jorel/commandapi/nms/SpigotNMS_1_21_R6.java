...
public class SpigotNMS_1_21_R6 extends CommandAPISpigot<CommandSourceStack> {
	...
	public SpigotNMS_1_21_R6(InternalSpigotConfig config) {
		super(config);
	}
	...
	public NMS<CommandSourceStack> bukkitNMS() {
		if (bukkitNMS == null) {
			this.bukkitNMS = new NMS_1_21_R6(() -> COMMAND_BUILD_CONTEXT);
		}
		return bukkitNMS;
	}
