...
public class BukkitStringTooltip extends StringTooltip {
	...
	public static StringTooltip ofAdventureComponent(String suggestion, ComponentLike tooltip) {
	...
	/**
	 * Constructs a collection of {@link StringTooltip} objects from an array of suggestions, and a function which generates
	 * a tooltip formatted as an adventure {@link ComponentLike} for each suggestion
	 *
	 ...
	 * 	tooltips
	 */
	public static Collection<StringTooltip> generateAdventureComponents(Function<String, ComponentLike> tooltipGenerator, String... suggestions) {
	 ...
	 * 	tooltips
	 */
	public static Collection<StringTooltip> generateAdventureComponents(Function<String, ComponentLike> tooltipGenerator, Collection<String> suggestions) {
		return generate(tooltipGenerator, BukkitStringTooltip::ofAdventureComponent, suggestions);
	}
}
